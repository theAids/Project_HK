<%@ Page Title="Login" Language="C#" AutoEventWireup="true" CodeBehind="Login.aspx.cs" Inherits="Project_HK.Accounts.Login" %>
...
<body class="login-body">
    <form runat="server">
        ...
        <div class="container">
            ...
            <!-- / Logo and project title -->
            <div class="row">
                <div class="col-sm-8 col-md-4 col-md-offset-4 col-sm-offset-2 text-center">
                    ...
                    <asp:Button ID="loginbtn" class="btn btn-lg btn-login" OnClick="loginbtn_Click" runat="server" Text="Login" />
                </div>
            </div>
        </div>
    </form>
